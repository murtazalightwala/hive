...
render()
{
    ...
    <View style = {styles.SignUpFormContainer}>
        ...
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Enter First Name' value = {this.state.firstname} onChangeText = {this.changeFirstName} />
        </View>
        <View style = {{
            width: '45%',
            flexDirection: 'column',
        ...
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Enter Last Name' value = {this.state.lastname} onChangeText = {this.changeLastName} />
        </View>
        </View>
        <View style = {{
            width: '100%',
        ...
        <DatePicker style = {styles.DateInput} mode = 'date' date = {this.state.dob} onDateChange = {this.changeDob} />
        </View>
        <View style = {{
            width: '45%',
            flexDirection: 'column',
        ...
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Please enter your relationship status' value = {this.state.relationship_status} onChangeText = {this.changeRelationshipStatus} />
        <Text style = {styles.SignUpFormText}>Children</Text>
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Enter Number of children' value = {this.state.children} onChangeText = {this.changeCountChildren} />
        <Text style = {styles.SignUpFormText}>Address</Text>
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Enter your Address' value = {this.state.address} onChangeText = {this.changeAddress} />
        <Text style = {styles.SignUpFormText}>Profession</Text>
        <TextInput style = {styles.SignUpFormTextInput} placeholder = 'Enter your Profession' value = {this.state.profession} onChangeText = {this.changeProfession}/>
        </ View>
